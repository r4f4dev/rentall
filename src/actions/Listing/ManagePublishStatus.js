  ...
  return async (dispatch, getState, { client }) => {
    ...
    try {
      ...
      if (upcomingBookingCount > 0 && action === 'unPublish') {
        toastr.error('Error!', 'You cannot unpublish as you have upcoming bookings or enquiries for this listing.');
        dispatch({
        ...
        if (data.managePublish.status === '200') {
          ...
          toastr.success('Success!', `Your listing has been ${type == 'Publish Listing' ? 'published' : 'unpublished'} successfully.`);
          dispatch({
          ...
          toastr.error('Error!', type + " is failed!");
          dispatch({
            type: MANANGE_LISTING_PUBLISH_STATUS_ERROR,
            payload: {
