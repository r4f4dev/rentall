...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/becomeHostStaticBlock'));
        reject(error);
      }),
    },
    {
    ...
    {
      path: '/siteadmin/tariffs',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/tariffs'));
        reject(error);
      }),
    },
    {
      path: '/siteadmin/tariffs/add',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/tariffs/add/'));
        reject(error);
      }),
    },
    {
