...
class Booking extends Component {
	...
	render() {
		...
		const { serviceFees, base, rates, specialPricing, tariff } = this.props;
			...
			<div>
...

				{
					page === 'payment' && <Payment
						...
						listType={bookingData.settingsData && bookingData.settingsData[0] && bookingData.settingsData[0].listsettings && bookingData.settingsData[0].listsettings.itemName}
...
const mapState = (state) => ({
	...
	tariff: state.viewListing.tariff,
