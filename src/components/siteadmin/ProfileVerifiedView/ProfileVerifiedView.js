...
class ProfileVerifiedView extends React.Component {
    ...
    render() {
        ...
        if (data.preferredLanguage == "id") {
            ...
            language = "日本語"
        } else if (data.preferredLanguage == "uz-UZ") {
            language = "Uzbek"
        } else if (data.preferredLanguage == "ru-RU") {
            language = "Russian"
        } else {
            language = "한국어"
        }
            ...
            <div className={cx(s.pagecontentWrapper, 'pagecontentAR')}>
                <div>
                    ...
                    <div className={cx(s.space4, bt.textAlignRight, 'textAlignLeftRtl')}>
                        <Link to={"/siteadmin/users"} className={cx(bt.btnPrimaryBorder, bt.btnLarge, bt.noTextDecoration, bt.btnPrimaryLink, 'bgBlack')}>
