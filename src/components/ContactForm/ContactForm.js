                                        ...
                                        <Col xs={12} sm={6} md={6} lg={6} className={s.noPadding}>
                                            ...
                                            <Col xs={12} sm={12} md={12} lg={12}>
                                                <Field name="name"
                                                    ...
                                                    className={cx(bt.commonControlInput, s.backgroundTwo, 'backgroundTwoRTL', 'backgroundTwoDark', 'darkAvater')}
                                                />
                                            </Col>
                                        </Col>
                                        <Col xs={12} sm={6} md={6} lg={6} className={s.noPadding}>
                                            ...
                                            <Col xs={12} sm={12} md={12} lg={12}>
                                                <Field name="phoneNumber"
                                                    ...
                                                    className={cx(bt.commonControlInput, s.backgroundThree, 'backgroundTwoRTL', 'darkCall')}
                                                />
                                            </Col>
                                        </Col>
                                    </Row>
                                    <Row className={s.formGroup}>
                                        ...
                                        <Col xs={12} sm={12} md={12} lg={12}>
                                            <Field name="email"
                                                ...
                                                className={cx(bt.commonControlInput, s.backgroundOne, 'backgroundTwoRTL', 'darkEmail')}
                                            />
                                        </Col>
                                    </Row>
                                    <Row className={s.formGroup}>
                                        ...
                                        <Col xs={12} sm={12} md={12} lg={12}>
                                            <Field name="ContactMessage"
                                                ...
                                                className={cx(bt.commonControlInput, s.backgroundFour, 'contactTextInputRTL', 'darkContact')}
                                            />
                                        </Col>
                                    </Row>
