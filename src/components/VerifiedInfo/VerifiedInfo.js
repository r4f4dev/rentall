...
class VerifiedInfo extends Component {
  ...
  render() {
    const { verifiedInfoData: { loading, getUserVerifiedInfo }, account, userId, showOwnProfile } = this.props;
    ...
    return this.template(
      <Accounts items={getUserVerifiedInfo} isLoggedInUser={isLoggedInUser} showOwnProfile={showOwnProfile} />
    );
  }
}
